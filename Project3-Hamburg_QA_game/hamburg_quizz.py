...
questions = [["1. Where is Hamburg's Rathaus located?", "MITTE"],
             ["2. Which district is known for its historic fish market?", "ALTONA"],
             ["3. Which districs has beautiful parks?", "WANDSBEK"],
             ["4. Which district is home to the Airbus manufacturing plant?", "HARBURG"]
