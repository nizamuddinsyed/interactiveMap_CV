...
travel_time_list = [
    #Altona
    ["ALTONA", "HARBURG", "[25 min (20.8 Km)]"],
    ["ALTONA", "WANDSBEK", "[33 min (17.5 Km)]"],
    ["ALTONA", "BERGEDORF", "[40 min (32.2 Km)]"],
    ["ALTONA", "MITTE", "[29 min (21.9 Km)]"],
    ["ALTONA", "EIMSBÜTTEL", "[15 min (7.5 Km)]"],
    ["ALTONA", "NORD", "[21 min (12.7 Km)]"],

    #Wandsbek
    ["WANDSBEK", "HARBURG", "[25 min (19.2 Km)]"],
    ["WANDSBEK", "ALTONA", "[31 min (16.9 Km)]"],
    ["WANDSBEK", "BERGEDORF", "[22 min (16 Km)]"],
    ["WANDSBEK", "MITTE", "[20 min (12 Km)]"],
    ["WANDSBEK", "EIMSBÜTTEL", "[19 min (10.7 Km)]"],
    ["WANDSBEK", "NORD", "[14 min (7.8 Km)]"],

    # Hamburg-Mitte
    ["MITTE", "HARBURG", "[13 min (10.2 Km)]"],
    ["MITTE", "ALTONA", "[31 min (22.4 Km)]"],
    ["MITTE", "BERGEDORF", "[18 min (19.4 Km)]"],
    ["MITTE", "WANDSBEK", "[20 min (12.4 Km)]"],
    ["MITTE", "EIMSBÜTTEL", "[21 min (12.6 Km)]"],
    ["MITTE", "NORD", "[24 min (14.2 Km)]"],

    # BERGEDORF
    ["BERGEDORF", "HARBURG", "[18 min (19.4 Km)]"],
    ["BERGEDORF", "ALTONA", "[40 min (32.2 Km)]"],
    ["BERGEDORF", "MITTE", "[18 min (19.4 Km)]"],
    ["BERGEDORF", "WANDSBEK", "[23 min (16 Km)]"],
    ["BERGEDORF", "EIMSBÜTTEL", "[25 min (24.0 Km)]"],
    ["BERGEDORF", "NORD", "[32 min (21.8 Km)]"],

    # Harburg
    ["HARBURG", "BERGEDORF", "[21 min (24.1 Km)]"],
    ["HARBURG", "ALTONA", "[25 min (20.5 Km)]"],
    ["HARBURG", "MITTE", "[12 min (11 Km)]"],
    ["HARBURG", "WANDSBEK", "[24 min (19.8 Km)]"],
    ["HARBURG", "EIMSBÜTTEL", "[25 min (20.1 Km)]"],
    ["HARBURG", "NORD", "[29 min (21.7 Km)]"],

    # Eimbsbüttel
    ["EIMSBÜTTEL", "BERGEDORF", "[32 min (27.1 Km)]"],
    ["EIMSBÜTTEL", "ALTONA", "[13 min (7.1 Km)]"],
    ["EIMSBÜTTEL", "MITTE", "[22 min (13.4 Km)]"],
    ["EIMSBÜTTEL", "WANDSBEK", "[20 min (11.2 Km)]"],
    ["EIMSBÜTTEL", "HARBURG", "[26 min (20.1 Km)]"],
    ["EIMSBÜTTEL", "NORD", "[10 min (5.9 Km)]"],

    # Hamburg Nord
    ["NORD", "BERGEDORF", "[32 min (21.8 Km)]"],
    ["NORD", "ALTONA", "[22 min (12.6 Km)]"],
    ["NORD", "MITTE", "[22 min (13.8 Km)]"],
    ["NORD", "WANDSBEK", "[14 min (7.8 Km)]"],
    ["NORD", "EIMSBÜTTEL", "[12 min (6.1 Km)]"],
    ["NORD", "HARBURG", "[27 min (20.9 Km)]"]
